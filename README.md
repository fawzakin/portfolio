...
# TODO:
- [ ] Have a look and feel similar to [garudalinux.org](garudalinux.org) and [yan-holtz.com](yan-holtz.com)
- [ ] Better background and profile image
- [ ] Optional Javascripts for pizazz
- [ ] Smooth scrolling
- [ ] Light/dark mode
- [ ] Language switching (EN/ID)

# License
AGPL V3 (code base only)
